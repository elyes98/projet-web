...
$liste = $comptes->confirmerReservation();
$compte = new utilisateurAdmin();
  ?>
<!DOCTYPE html>
<html lang="en">
                    ...
                    <ul class="list-unstyled navbar__list">
                        ...
                        <li class="active has-sub">
                            ...
                            <ul class="list-unstyled navbar__sub-list js-sub-list">
                                <li>
                                    <a href="calendar.php">Consulter</a>
                                </li>
                                <li>
                                    <a href="calendar1.php">Calendrier</a>
                                </li>
                                <li>
                                    <a href="chart.php">Stat</a>
                                </li>
                            </ul>
                        </li>
                        <li class="has-sub">
...
// var tues = moment().day(6).hour(19);
  ...
  var events = [
    ...
    foreach ($liste as $row){
        $ch=substr($row['date'],5,2);
        $hd=$row['tempsDebut'];
        $l = $compte->getCompte('cin',$row['cinUtilisateur']);
        foreach ($l as $r){}
        
    ?>
    {
      title: '<?php echo $r['nom'].' '.$r['prenom'];?>' ,
       start: moment().hour(<?php echo $hd;?>).add(<?php echo $hd;?>-1-j, 'days').toISOString(),
      url: '#'
    },
    <?php 
    }
