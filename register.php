                ...
                <div class="login-wrap">
                    <div class="login-content">
                        <div class="login-form">
                            <form action="registrerCompte.php" method="post">
                            <div class="form-group">
                                ...
                                <div class="form-group">
                                    <input class="au-input au-input--full" type="tel" name="tel" placeholder="tel">
                                </div>
                                <div class="form-group">
                                    <input class="au-input au-input--full" type="password" name="passe" placeholder="Password">
                                </div>
